...
73 studies used the STRESS guideline to report their simulation work. This could be further break down to:
...
![No. publications using STRESS by year](../03_results/figures/figure_1.png){#fig-fig1}
:::
...
![Simulation methods](../03_results/figures/figure_2.png){#fig-fig2}
:::
...
A potential explanation for the higher uptake in health is that the guidelines are listed on the [Equator Network website](https://www.equator-network.org/reporting-guidelines/strengthening-the-reporting-of-empirical-simulation-studies-introducing-the-stress-guidelines). This increases the chance of discovery by simulation modellers working in health.
...
![Application area](../03_results/figures/figure_3.png){#fig-fig3}
:::
...
![Authors approach to using STRESS within articles](../03_results/figures/figure_4.png){#fig-fig4}
:::
...
Finally, the code access element was referenced in 38 studies that employed the STRESS guideline. A further assessment of the papers that provided a code access statement revealed that most authors shared their source code through links to repositories such as GitHub or included it as an appendix (23 or 32% of papers). Eleven studies indicated that the code would be available upon request, while a few papers mentioned confidentiality reasons for not sharing the model or stated that they would provide it in future publications.  

The rate of model code sharing of 32% was **overall** higher than others have found at in DES for health at 8% [Monks and Harper, 2023)](https://www.tandfonline.com/doi/full/10.1080/17477778.2023.2260772) and ABS at 11% [(Jannsen et al, 2020)](https://www.sciencedirect.com/science/article/pii/S1364815220309300). Our sample size is small, but the finding for DES held when we stratified results by method: DES models were shared 34% of the time (n=38, coded model available = 13). 
